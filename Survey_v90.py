...
#Magnitude erros modo Continuo e estacionário
    ...
    #Modo de propagação sistematico 
        self.Mag_XYM1_GYRO       = 0.04#0.1 #deg
        self.Mag_XYM2_GYRO       = 0.04#0.1 #deg
        self.Mag_XYM3_GYRO       = 0.04#0.2 #deg
        self.Mag_XYM4_GYRO       = 0.04#0.2 #deg
